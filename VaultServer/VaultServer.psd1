...
GUID = '0b449faf-3d36-4f87-bad5-5ee8913b6643'
...
FunctionsToExport = 'Add-CAPubKeyToSSHAndSSHDConfig','Configure-VaultServerForLDAPAuth',
                    'Configure-VaultServerForSSSHManagement','Get-LDAPCert','Get-VaultAccessorLookup',
                    'Get-VaultLogin','Get-VaultTokenAccessors','Get-VaultTokens',
                    'New-SSHCredentials','Revoke-VaultToken','Sign-SSHHostPublicKey',
                    'Sign-SSHUserPublicKey'
